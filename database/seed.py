...
def seed_db():
    ...
    print(f"--- Starte Seeding für Datenbank: {db_name} ---")
    ...
    db.manufacturers.insert_many(manufacturers_data)
    mf_map = {m["name"]: m["_id"] for m in db.manufacturers.find()}
    ...
    db.engines.insert_many(engines_data)
    eng_map = {e["code"]: e["_id"] for e in db.engines.find()}

    # 4. CAR_MODELS
    car_models_data = [
        {"model": "911 Turbo S", "year": 2024, "cat": "Sport", "price": 270000, "colors": ["Silver", "Black", "White", "Guards Red"], "specs": { "drive": "AWD", "top_speed_kmh": 330, "weight_kg": 1640, "seats": 4 }, "engine_id": eng_map["B6-4.0"], "manufacturer_id": mf_map["Porsche"]},
        {"model": "Taycan S", "year": 2024, "cat": "Luxury", "price": 200000, "colors": ["Blue", "White", "Black"], "specs": { "drive": "AWD", "top_speed_kmh": 250, "weight_kg": 2295, "seats": 4, "range_km": 490 }, "engine_id": eng_map["Taycan-S"], "manufacturer_id": mf_map["Porsche"]},
        {"model": "Model S Plaid", "year": 2024, "cat": "Sedan", "price": 110000, "colors": ["Red", "White", "Black", "Silver"], "specs": { "drive": "AWD", "top_speed_kmh": 322, "weight_kg": 2162, "seats": 5, "range_km": 600 }, "engine_id": eng_map["Plaid-Tri"], "manufacturer_id": mf_map["Tesla"]},
        {"model": "M3 Competition", "year": 2024, "cat": "Sedan", "price": 105000, "colors": ["Blue", "Black", "White"], "specs": { "drive": "RWD", "top_speed_kmh": 290, "weight_kg": 1730, "seats": 5 }, "engine_id": eng_map["I6-3.0"], "manufacturer_id": mf_map["BMW"]},
        {"model": "EQS 580", "year": 2024, "cat": "Luxury", "price": 150000, "colors": ["Black", "Silver", "White"], "specs": { "drive": "AWD", "top_speed_kmh": 210, "weight_kg": 2585, "seats": 5, "range_km": 780 }, "engine_id": eng_map["EQ-Dual"], "manufacturer_id": mf_map["Mercedes-Benz"]},
        {"model": "A45 S", "year": 2024, "cat": "Compact", "price": 80000, "colors": ["Grey", "White", "Black"], "specs": { "drive": "AWD", "top_speed_kmh": 270, "weight_kg": 1625, "seats": 5 }, "engine_id": eng_map["I4-2.0-A"], "manufacturer_id": mf_map["Mercedes-Benz"]},
        {"model": "812 Competizione", "year": 2023, "cat": "Sport", "price": 500000, "colors": ["Yellow", "Red", "Black"], "specs": { "drive": "RWD", "top_speed_kmh": 340, "weight_kg": 1525, "seats": 2 }, "engine_id": eng_map["V12-6.5"], "manufacturer_id": mf_map["Ferrari"]},
        {"model": "Nevera", "year": 2024, "cat": "Hypercar", "price": 2000000, "colors": ["Blue", "Carbon Black"], "specs": { "drive": "AWD", "top_speed_kmh": 412, "weight_kg": 1900, "seats": 2, "range_km": 550 }, "engine_id": eng_map["Rimac-Q"], "manufacturer_id": mf_map["Rimac"]},
        {"model": "Huracán STO", "year": 2023, "cat": "Sport", "price": 320000, "colors": ["Green", "Orange", "White"], "specs": { "drive": "RWD", "top_speed_kmh": 310, "weight_kg": 1339, "seats": 2 }, "engine_id": eng_map["V10-5.2"], "manufacturer_id": mf_map["Lamborghini"]},
        {"model": "Urus", "year": 2024, "cat": "SUV", "price": 260000, "colors": ["Black", "White", "Yellow", "Blue"], "specs": { "drive": "AWD", "top_speed_kmh": 305, "weight_kg": 2197, "seats": 5 }, "engine_id": eng_map["V8-4.0"], "manufacturer_id": mf_map["Lamborghini"]},
        {"model": "Air Sapphire", "year": 2024, "cat": "Luxury", "price": 250000, "colors": ["Grey", "White", "Black"], "specs": { "drive": "AWD", "top_speed_kmh": 330, "weight_kg": 2394, "seats": 5, "range_km": 687 }, "engine_id": eng_map["Lucid-D"], "manufacturer_id": mf_map["Lucid Motors"]},
        {"model": "R1S", "year": 2024, "cat": "SUV", "price": 90000, "colors": ["White", "Green", "Black", "Blue"], "specs": { "drive": "AWD", "top_speed_kmh": 180, "weight_kg": 3107, "seats": 7, "range_km": 515 }, "engine_id": eng_map["Rivian-Q"], "manufacturer_id": mf_map["Rivian"]},
        {"model": "Chiron", "year": 2022, "cat": "Hypercar", "price": 3500000, "colors": ["Blue", "Black", "Silver"], "specs": { "drive": "AWD", "top_speed_kmh": 420, "weight_kg": 1995, "seats": 2 }, "engine_id": eng_map["W16-8.0"], "manufacturer_id": mf_map["Bugatti"]},
        {"model": "ET7", "year": 2024, "cat": "Sedan", "price": 85000, "colors": ["Brown", "White", "Black"], "specs": { "drive": "AWD", "top_speed_kmh": 200, "weight_kg": 2379, "seats": 5, "range_km": 1000 }, "engine_id": eng_map["Nio-150"], "manufacturer_id": mf_map["Nio"]},
        {"model": "Polestar 2", "year": 2024, "cat": "Sedan", "price": 60000, "colors": ["Gold", "White", "Black", "Blue"], "specs": { "drive": "AWD", "top_speed_kmh": 205, "weight_kg": 2123, "seats": 5, "range_km": 476 }, "engine_id": eng_map["PS-Dual"], "manufacturer_id": mf_map["Polestar"]},
        {"model": "Eletre R", "year": 2024, "cat": "SUV", "price": 140000, "colors": ["Yellow", "Black", "White"], "specs": { "drive": "AWD", "top_speed_kmh": 265, "weight_kg": 2580, "seats": 5, "range_km": 490 }, "engine_id": eng_map["Lotus-E"], "manufacturer_id": mf_map["Lotus"]},
        {"model": "A110 S", "year": 2024, "cat": "Sport", "price": 75000, "colors": ["Orange", "Blue", "White"], "specs": { "drive": "RWD", "top_speed_kmh": 250, "weight_kg": 1115, "seats": 2 }, "engine_id": eng_map["A110-I4"], "manufacturer_id": mf_map["Alpine"]},
        {"model": "Vantage", "year": 2024, "cat": "Sport", "price": 180000, "colors": ["Silver", "Green", "Black"], "specs": { "drive": "RWD", "top_speed_kmh": 313, "weight_kg": 1530, "seats": 2 }, "engine_id": eng_map["V8-5.5"], "manufacturer_id": mf_map["Aston Martin"]},
        {"model": "XC90", "year": 2024, "cat": "SUV", "price": 95000, "colors": ["White", "Black", "Silver"], "specs": { "drive": "AWD", "top_speed_kmh": 210, "weight_kg": 2196, "seats": 7 }, "engine_id": eng_map["H-V6-3.0"], "manufacturer_id": mf_map["Volvo"]},
        {"model": "Han EV", "year": 2024, "cat": "Sedan", "price": 55000, "colors": ["Grey", "White", "Black"], "specs": { "drive": "AWD", "top_speed_kmh": 180, "weight_kg": 2030, "seats": 5, "range_km": 521 }, "engine_id": eng_map["Nio-150-B"], "manufacturer_id": mf_map["BYD"]}
    ]
    db.car_models.insert_many(car_models_data)

    # 5. Rückreferenz in Manufacturers (car_model_ids)
    for car in db.car_models.find():
